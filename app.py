...
password = "sparta"
cxn_str = f"mongodb+srv://test:{password}@cluster0.ex5d4.mongodb.net/?retryWrites=true&w=majority"
...
def create_restaurant():
    ...
    return jsonify(
        {"result": "success", "msg": "Kamu berhasil membuat data restoranmu!"}
    )
...
def delete_restaurant():
    ...
    return jsonify(
        {"result": "success", "msg": "Kamu berhasil menghapus data restoranmu!"}
    )
